...
app.use('/users',userRouter); // http://localhost:3000/users -> userRouter ->http://localhost:6000/users/create ->createUser funtion controller vala hit hog....
app.use('/auth',authRouter); //  http://localhost:3000/auth -> authRouter -> http://localhost:6000/auth/login -> loginUser function controller vala hit hoga....
